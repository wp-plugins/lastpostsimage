...
if( !function_exists('lpi_plugin_basename') ) {
...
// add actions
  ...
  add_action( 'activate_'.lpi_plugin_basename(),   'lpi_activate' );
  add_action( 'deactivate_'.lpi_plugin_basename(), 'lpi_deactivate' );
  // admin menu
